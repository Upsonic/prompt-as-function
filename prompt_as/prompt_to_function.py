...
try:
    from .utils.old_functions import (
        get_function_index,
        get_code_of_function,
        set_function_to_code_base,
        get_old_functions,
        get_old_codes,
        the_functions,
...
def prompt_to_function(
    prompt: str, tester: bool = False, more=False, function_name=None
):
...
""",
    ...
    if function_name == None or function_name not in the_functions:
        result = crew.kickoff()
        ...
        if not more:
            ...
            return {
                "function": result,
                "related": get_old_functions(pre_check_prompt),
                "related_codes": get_old_codes(pre_check_prompt),
            }
    else:
