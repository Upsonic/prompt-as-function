...
def multpley_tree_single_digit(
    number_one: int, number_two: int, number_tree: int
) -> int:
    """
...
@pf
def multpley_three_double_digit(
    number_one: int, number_two: int, number_three: int
) -> int:
    """
...
test_systems = [
    ...
    Prompt_As_Test_System(
        check_password, [(["onuratakan", "13532"], {})], [False], [None]
    ),
    Prompt_As_Test_System(
        check_password, [(["onuratakan", "6431"], {})], [True], [None]
    ),
    ...
    Prompt_As_Test_System(
        multpley_three_double_digit, [(40, 20, 10)], [8000], [None], int
    ),
    Prompt_As_Test_System(
        multpley_three_double_digit, [(10, 90, 10)], [9000], [None], int
    ),
    Prompt_As_Test_System(
        multpley_three_double_digit, [(90, 90, 20)], [162000], [None], int
    ),
    Prompt_As_Test_System(
        multpley_three_double_digit, [(10, 10, 10)], [1000], [None], int
    ),
    Prompt_As_Test_System(
        multpley_three_double_digit, [(50, 50, 40)], [100000], [None], int
    ),
    Prompt_As_Test_System(
        encrypt_via_fernet, [("Hello World", "I am encrypt1234")], None, [None], str
    ),
